...
public class CamareiraOcupada extends JInternalFrame {

		public CamareiraOcupada() {
			setBounds(100, 100, 530, 300);
			getContentPane().setLayout(null);
			
			JLabel lblServiosCadastrados = new JLabel("Camareiras Ocupadas");
			...
			Object[] serv = DaoSupplier.getDaoCamareira().findAllOcupados().toArray();
		...
		private DefaultListModel<Camareira> loadList() { 
			List<Camareira> cam = DaoSupplier.getDaoCamareira().findAllOcupados();
